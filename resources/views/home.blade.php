...
<div class="pt-10 mr-50 ml-50 mt-50">
    ...
    <button class="mt-4 bg-amber-400 text-black px-6 py-2 rounded-lg hover:bg-amber-500 transition font-extrabold">
        <a href="{{ route('destination') }}">Cari Destinasi</a>
    </button>
</div>
</section>
...
<section class="py-16 ">
        ...
        <div class="flex justify-between items-center mb-12 mr-50 ml-50 ">
            ...
            <a href="{{ route('destination') }}" class="bg-amber-400 text-black px-6 py-2 rounded hover:bg-amber-500 transition font-medium">Lihat Semua Destinasi</a>
        </div>
      ...
      <div class="marquee flex gap-1 mt-4">
        ...
        <div class="w-45">
          ...
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou12.jpg') }}" alt="Image 1" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 2 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou1.jpg') }}" alt="Image 1" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 3 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou2.jpg') }}" alt="Image 2" class="w-full h-45 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 4 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou4.jpg') }}" alt="Image 3" class="w-full h-30 object-cover rounded-lg">
          </div>
          <!-- Card 5 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou6.jpg') }}" alt="Image 4" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 6 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou5.jpg') }}" alt="Image 5" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 7 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou6.jpg') }}" alt="Image 6" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 8 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou7.jpg') }}" alt="Image 7" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 9 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou8.jpg') }}" alt="Image 8" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 10 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou9.jpg') }}" alt="Image 9" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 11 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou10.jpg') }}" alt="Image 10" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 12 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou11.jpg') }}" alt="Image 11" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 13 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou12.jpg') }}" alt="Image 12" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 14 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou4.jpg') }}" alt="Image 13" class="w-full h-25 object-cover rounded-lg">
          </div>
          <!-- Card 15 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou6.jpg') }}" alt="Image 14" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 16 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou2.jpg') }}" alt="Image 15" class="w-full h-20 object-cover rounded-lg">
          </div>
          <!-- Card 17 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou1.jpg') }}" alt="Image 16" class="w-full h-48 object-cover rounded-lg">
          </div>
          <!-- Card 18 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou7.jpg') }}" alt="Image 17" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 19 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou10.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou10.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
        ...
        <div class="w-45">
          <!-- Card 19 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou3.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou5.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou6.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
        </div>
        ...
        <div class="w-45">
          <!-- Card 19 -->
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou12.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou11.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
          <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
            <img src="{{ asset('storage/img/carou3.jpg') }}" alt="Image 18" class="w-full h-25 object-cover rounded-lg">
          </div>
        ...
        <div class="w-45">
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou11.jpg') }}" alt="Image 18" class="w-full h-40 object-cover rounded-lg">
            </div>
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou4.jpg') }}" alt="Image 18" class="w-full h-40 object-cover rounded-lg">
            </div>
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou1.jpg') }}" alt="Image 18" class="w-full h-40 object-cover rounded-lg">
            </div>
          </div>
           <!-- Group 9 -->
        <div class="w-45">
        ...
        <div class="w-45">
          ...
          <div class="w-45">
            ...
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou4.jpg') }}" alt="Image 13" class="w-full h-40 object-cover rounded-lg">
            </div>
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou6.jpg') }}" alt="Image 14" class="w-full h-40 object-cover rounded-lg">
            </div>
          </div>
          ...
          <div class="w-45">
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou2.jpg') }}" alt="Image 15" class="w-full h-25 object-cover rounded-lg">
            </div>
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou1.jpg') }}" alt="Image 16" class="w-full h-25 object-cover rounded-lg">
            </div>
            <div class="bg-white rounded-lg inset-shadow-sm shadow-l m-1 border-1 border-gray-200 overflow-hidden p-2">
              <img src="{{ asset('storage/img/carou7.jpg') }}" alt="Image 17" class="w-full h-25 object-cover rounded-lg">
            </div>
